    ...
    public partial class InitialCreate1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_workShopLocs", x => x.WorkShopId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MaintenanceHistories_Equipment_EquipmentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastGeneratedDate = table.Column<DateOnly>(type: "date", nullable: false),
                    EquipmentId = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskLogsAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TaskLogsAttachments_TaskLogs_LogId",
                        column: x => x.LogId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TaskLogsAttachments_LogId",
                table: "TaskLogsAttachments",
                column: "LogId");
