...
namespace Maintenance_Scheduling_System.Application.Services
{
    public class TaskLogAttachmentService : ITaskLogAttachmentService
    {
        ...
        public TaskLogAttachmentService(ITaskLogRepo logrepo, ITaskLogAttachmentsRepo attachrepo, ICurrentUser user)
        {
        ...
        public async Task DeleteAttachment(int attachId)
        {
        ...
        public async Task UploadAttachment(int logId, IFormFile file)
        {
            ...
            string uploadsFolder = "C:\\Users\\Administrator\\source\\repos\\Maintenance_Scheduling_System\\Maintenance_Scheduling_System\\Uploads";
