...
{
    public class GetAllMainTasksHandler : IRequestHandler<GetAllMainTasksQuery, List<MainTaskDTO>>
    {
        private readonly IMapper _mapper;
        private readonly IMainTaskRepo _taskRepo;

        public GetAllMainTasksHandler(IMapper mapper, IMainTaskRepo taskRepo)
        {
            _mapper = mapper;
            _taskRepo = taskRepo;
        }

        public async Task<List<MainTaskDTO>> Handle(GetAllMainTasksQuery request, CancellationToken cancellationToken)
        {
