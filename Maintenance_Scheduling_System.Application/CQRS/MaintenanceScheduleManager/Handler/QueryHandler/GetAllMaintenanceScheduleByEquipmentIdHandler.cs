...
{
    public class GetMaintenanceSchedulesByEquipmentIdHandler: IRequestHandler<GetMaintenanceSchedulesByEquipmentIdQuery, List<DisplayMaintenanceScheduleDTO>>
    {
        private readonly IMaintenanceScheduleRepo _repo;
        private readonly IMapper _mapper;
        private readonly IMediator _mediator;

        public GetMaintenanceSchedulesByEquipmentIdHandler( IMaintenanceScheduleRepo repo, IMapper mapper,IMediator mediator)
        {
            _repo = repo;
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<List<DisplayMaintenanceScheduleDTO>> Handle(GetMaintenanceSchedulesByEquipmentIdQuery request,CancellationToken cancellationToken)
        {
            var schedules = await _repo.GetAllMaintenanceScheduleByEquipId(request.EquipmentId);
