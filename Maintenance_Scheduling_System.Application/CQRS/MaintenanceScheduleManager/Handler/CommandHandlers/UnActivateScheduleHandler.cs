...
{
    public class UnactivateScheduleHandler : IRequestHandler<UnActivateScheduleCommand, DisplayMaintenanceScheduleDTO>
    {
        private readonly IMaintenanceScheduleRepo _repo;
        private readonly IMapper _mapper;
        private readonly IMediator _mediator;

        public UnactivateScheduleHandler(IMaintenanceScheduleRepo repo, IMapper mapper, IMediator mediator)
        {
            _repo = repo;
            _mapper = mapper;
            _mediator = mediator;
        ...
        public async Task<DisplayMaintenanceScheduleDTO> Handle(UnActivateScheduleCommand request, CancellationToken cancellationToken)
        {
